...
MIN_TEXT_CHARS = 500   # ít hơn ngưỡng này → coi là ảnh scan
...
def pdf_to_images_base64(pdf_path: str, dpi: int = 300, max_pages: int = 4) -> list[str]:
    """Dùng PyMuPDF (fitz) — không cần poppler."""
    import fitz
    import io
